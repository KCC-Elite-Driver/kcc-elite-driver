    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-2xl font-bold text-foreground">{t.admin_login_title}</h1>
          <p className="font-sans text-sm text-muted-foreground mt-1">{t.admin_login_desc}</p>
        </div>

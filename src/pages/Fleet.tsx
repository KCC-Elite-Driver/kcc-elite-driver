  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        {/* Amenities */}
        <div className="mb-6">
          <h4 className="font-sans text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">
            {t.fleet_amenities}
          </h4>
  ...
  const vehicles = [
    {
      ...
      amenities: [
        ...
        { icon: Plug, label: t.fleet_chargers },
      ],
    },
    {
      name: t.fleet_first,
      ...
      amenities: [
        ...
        { icon: Droplets, label: t.fleet_water },
        { icon: Plug, label: t.fleet_chargers },
        { icon: Newspaper, label: t.fleet_press },
        { icon: DoorOpen, label: t.fleet_partition },
      ],
    },
    {
      name: t.fleet_van,
      ...
      amenities: [
        ...
        { icon: Droplets, label: t.fleet_water },
        { icon: Plug, label: t.fleet_chargers },
        { icon: LayoutGrid, label: t.fleet_conference },
      ],
    },
  ];

...
const ValuesSection = () => {
  ...
  const values = [
    {
      icon: ShieldCheck,
      title: t.values_discretion,
      desc: t.values_discretion_desc,
    },
    {
      icon: Clock,
      title: t.values_punctuality,
      desc: t.values_punctuality_desc,
    },
    {
      icon: Languages,
      title: t.values_multilingual,
      desc: t.values_multilingual_desc,
    },
  ];

...
export const translations: Record<Language, TranslationKeys> = { // v3
  ...
  en: {
    ...
    fleet_suv: "SUV Prestige",
    fleet_suv_desc: "Soueast S07 or equivalent. Premium technology and generous space for your demanding journeys. Fitted with ultra-high-speed WiFi, multi-zone climate control, premium refreshments and international press on board.",
  ...
  ar: {
    ...
    fleet_suv_desc: "سوايست S07 أو ما يعادلها. تقنية متميزة ومساحة سخية لرحلاتكم المتطلبة. مجهزة بواي فاي فائق السرعة، تكييف متعدد المناطق، مرطبات فاخرة وصحافة فرنسية ودولية على متنها.",

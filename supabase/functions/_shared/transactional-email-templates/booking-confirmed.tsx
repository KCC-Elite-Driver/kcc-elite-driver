...
const BookingConfirmedEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your reservation is confirmed — {BRAND}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your reservation is now <strong style={{ color: INK }}>confirmed</strong>.
          Your chauffeur will meet you at the agreed time and location.
        </Text>
        ...
        <Section style={detailsBox}>
          ...
          {driverName && <Row label="Chauffeur" value={driverName} />}
          {driverPhone && <Row label="Contact" value={driverPhone} />}
        </Section>

        <Text style={text}>
          Should you need to amend any detail, please reply to this email or
...
export const template = {
  ...
  displayName: 'Booking confirmed (client)',
  previewData: {
    firstname: 'Alexandre',
